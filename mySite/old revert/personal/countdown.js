...
window.addEventListener('DOMContentLoaded', function() {
  var days = [];
  [].forEach.call(document.querySelectorAll('.days'),  function(el) {
    days.push(new EasyPieChart(el, options));
  });
});

window.addEventListener('DOMContentLoaded', function() {
  var hours = [];
  [].forEach.call(document.querySelectorAll('.hours'),  function(el) {
    hours.push(new EasyPieChart(el, options));
  });
});

window.addEventListener('DOMContentLoaded', function() {
  var minutes = [];
  [].forEach.call(document.querySelectorAll('.minutes'),  function(el) {
    minutes.push(new EasyPieChart(el, options));
  });
});

window.addEventListener('DOMContentLoaded', function() {
  var seconds = [];
  [].forEach.call(document.querySelectorAll('.seconds'),  function(el) {
    seconds.push(new EasyPieChart(el, options));
  });
});
